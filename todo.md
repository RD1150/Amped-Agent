...
## Avatar UX Improvements (Apr 2026)
...
## Property Tour Voice-Over Narration (Apr 2026)
- [ ] Add voice-over toggle to Property Tour UI (on/off switch)
- [ ] Add narration script field — auto-generated by AI from property details, editable
- [ ] Add voice selection — use agent's cloned ElevenLabs voice if available, else default
- [ ] Update server router to generate narration script with LLM
- [ ] Synthesize narration audio with ElevenLabs API
- [ ] Upload narration audio to S3
- [ ] Pass audio track URL to Shotstack alongside Ken Burns video clips
- [ ] Show "Narrated Tour" badge on completed video cards
