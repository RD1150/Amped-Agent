      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6">
          <section>
            ...
            <p>
              Realty Content Agent uses artificial intelligence to generate social media content. While our AI is trained to produce high-quality, relevant content for real estate professionals, it is essential that you understand the following:
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              By using Realty Content Agent, you acknowledge and agree that:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>You will not hold Realty Content Agent liable for any consequences resulting from your use of AI-generated content</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Realty Content Agent is not responsible for:
            </p>
            <ul className="list-disc pl-6 space-y-2">
