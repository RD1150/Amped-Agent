    ...
    <div className="container max-w-4xl py-12">
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        ...
        <section>
          ...
          <p>
            Amped Agent ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI-powered content generation platform for real estate professionals.
          </p>
          <p>
            By using Amped Agent, you agree to the collection and use of information in accordance with this Privacy Policy. If you do not agree with our policies and practices, please do not use our Service.
          </p>
        </section>
        ...
        <section>
          ...
          <p>We may receive information from third-party services you connect to Amped Agent:</p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section>
          ...
          <p>
            Amped Agent integrates with several third-party services to provide our features. These services have their own privacy policies and may collect data independently:
          </p>
        ...
        <section>
          ...
          <p>
            Amped Agent is not intended for users under 18 years of age. We do not knowingly collect personal information from children. If you believe we have collected information from a child, please contact us immediately at <strong>privacy@authoritycontent.co</strong>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your information may be transferred to and processed in countries other than your country of residence. These countries may have different data protection laws. By using Amped Agent, you consent to the transfer of your information to the United States and other countries where we operate.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We may update this Privacy Policy from time to time to reflect changes in our practices or legal requirements. We will notify you of material changes via email or through the Service. Your continued use of Amped Agent after such changes constitutes acceptance of the updated Privacy Policy.
          </p>
        </section>
