    ...
    <div className="max-w-4xl mx-auto space-y-6 py-8">
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            Welcome to AmpedAgent ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. 
            This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.
          </p>
          <p>
            AmpedAgent is a premium real estate content AI platform that helps real estate professionals create, schedule, and publish 
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <div>
            ...
            <p>When you register for AmpedAgent, we collect:</p>
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            AmpedAgent is not intended for use by individuals under 18 years of age. We do not knowingly collect 
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            ...
            through a prominent notice on our platform. Your continued use of AmpedAgent after changes constitutes acceptance 
