    ...
    <div className="max-w-4xl mx-auto space-y-6 py-8">
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            Welcome to Amped Agent ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. 
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <div>
            ...
            <p>When you register for Amped Agent, we collect:</p>
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            Amped Agent is not intended for use by individuals under 18 years of age. We do not knowingly collect 
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            ...
            through a prominent notice on our platform. Your continued use of Amped Agent after changes constitutes acceptance 
