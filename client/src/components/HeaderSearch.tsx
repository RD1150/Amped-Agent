...
const ALL_PAGES = [
  ...
  { icon: Building2,   label: "Listing Video",           path: "/property-tours",       section: "LISTINGS", description: "Ken Burns video for any listing" },
  { icon: Film,        label: "Cinematic Tour",          path: "/cinematic-walkthrough",section: "LISTINGS", description: "AI-animated cinematic property tour" },
