...
export default function AuthorityScore() {
  ...
  const getScoreLabel = (score: number) => {
    ...
    if (score >= 60) return "Building Authority";
    ...
    <Card className="p-6 bg-gradient-to-br from-amber-500/5 to-amber-600/5 border-primary/20">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold">Authority Score</h2>
            <p className="text-sm text-muted-foreground">
              Your market dominance rating
            </p>
          </div>
          <div className="text-right">
            <div className={`text-4xl font-bold ${getScoreColor(authorityScore)}`}>
              {authorityScore}
        ...
        <div className="space-y-2">
          <Progress value={authorityScore} className="h-3" />
