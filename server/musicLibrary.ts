...
export const MUSIC_LIBRARY: MusicTrack[] = [
  // CALM & PROFESSIONAL (Perfect for luxury property tours)
  {
    ...
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/5f1e9a0c-ba3f-4d1e-8e0e-5c8f9b0a1e2f.mp3',
    duration: 120,
    pace: 'slow',
    mood: 'calm',
    genre: 'Piano',
  ...
  },
  {
    ...
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/ambient-calm-120s.mp3',
    duration: 120,
    pace: 'slow',
    mood: 'calm',
    genre: 'Ambient',
  ...
  },
  {
    ...
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/corporate-professional-90s.mp3',
    duration: 90,
    pace: 'medium',
    mood: 'professional',
    genre: 'Corporate',
  ...
  // UPLIFTING & ENERGETIC (Great for Authority Reels and modern homes)
  {
    ...
    title: 'Sunny Day',
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/upbeat-pop-60s.mp3',
    duration: 60,
    pace: 'upbeat',
    mood: 'uplifting',
    genre: 'Pop',
  ...
  },
  {
    ...
    title: 'Modern Vibes',
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/energetic-electronic-75s.mp3',
    duration: 75,
    pace: 'fast',
    mood: 'energetic',
    genre: 'Electronic',
  ...
  },
  {
    ...
    title: 'Fresh Start',
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/uplifting-acoustic-90s.mp3',
    duration: 90,
    pace: 'medium',
    mood: 'uplifting',
    genre: 'Acoustic',
  ...
  // DRAMATIC & LUXURIOUS (Premium properties and cinematic tours)
  {
    ...
    title: 'Grand Reveal',
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/dramatic-cinematic-120s.mp3',
    duration: 120,
    pace: 'medium',
    mood: 'dramatic',
    genre: 'Cinematic',
  ...
  },
  {
    ...
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/luxurious-strings-100s.mp3',
    duration: 100,
    pace: 'slow',
    mood: 'luxurious',
    genre: 'Orchestral',
  ...
  },
  {
    ...
    title: 'Showstopper',
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/dramatic-trailer-60s.mp3',
    duration: 60,
    pace: 'fast',
    mood: 'dramatic',
    genre: 'Trailer',
  ...
  // PROFESSIONAL & VERSATILE (All-purpose tracks)
  {
    ...
    title: 'Smart Home',
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/professional-tech-80s.mp3',
    duration: 80,
    pace: 'medium',
    mood: 'professional',
    genre: 'Tech',
  ...
  },
  {
    ...
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/versatile-indie-90s.mp3',
    duration: 90,
    pace: 'medium',
    mood: 'uplifting',
    genre: 'Indie',
  ...
  },
  {
    ...
    title: 'Bold Move',
    artist: 'Shotstack Audio',
    url: 'https://cdn.shotstack.io/au/v1/msgtwx8iw6/energetic-rock-75s.mp3',
    duration: 75,
    pace: 'fast',
    mood: 'energetic',
    genre: 'Rock',
