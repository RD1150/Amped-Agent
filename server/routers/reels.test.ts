  ...
  describe("getUsage", () => {
    it("should return usage stats for authenticated user", async () => {
      const caller = reelsRouter.createCaller({
        user: { id: 1, name: "Test User", email: "test@example.com", role: "user", subscriptionStatus: "active" as any, createdAt: new Date(), updatedAt: new Date(), lastSignedIn: new Date(), loginMethod: "manus", openId: "test-open-id" },
        req: {} as any,
        res: {} as any,
      });
