...
export const STRIPE_PRODUCTS: StripeProduct[] = [
  {
    ...
    priceIdMonthly: "price_1TP7Mn5Nd6YqBMkjqKbm4bGQ",
    priceIdYearly: "price_1TP7Mo5Nd6YqBMkj1Klnzqs4",
    productId: "prod_UNt91Kwu61r45a",
    trialDays: 14,
    monthlyCredits: 50,
    features: {
  ...
  },
  {
    ...
    priceIdMonthly: "price_1TP7Mp5Nd6YqBMkj09vZZFDq",
    priceIdYearly: "price_1TP7Mq5Nd6YqBMkjIRVmjrmV",
    productId: "prod_UNt9uSAqYx6xnN",
    trialDays: 14,
    recommended: true,
    monthlyCredits: 150,
    features: {
  ...
  },
  {
    ...
    priceIdMonthly: "price_1TP7Mr5Nd6YqBMkjaPLKggVv",
    priceIdYearly: "price_1TP7Ms5Nd6YqBMkjSZMcWG0O",
    productId: "prod_UNt9gzGoiZJwlo",
    trialDays: 14,
    monthlyCredits: 500,
    features: {
      contentGeneration: true,
